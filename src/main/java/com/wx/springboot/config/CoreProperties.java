...
//    private Fallback fallback = new Fallback();
    ...
    public static class Resource {
         ...
         * 认证头名称
         */
        private String authHeaderName = TokenConstants.DEFAULT_HEADER_AUTH;
...
//    }
//
//    public CoreProperties setFallback(Fallback fallback) {
...
//    }
    ...
    public static class Interceptor {
        private List<String> ignoreHeaders = new ArrayList<>();
    ...
    /**
     * feign fallback 默认处理类型
     */
//    public static class Fallback {
//        private FallbackUtils.FallbackType defaultFallback = FallbackUtils.FallbackType.EXCEPTION;
//
//        public FallbackUtils.FallbackType getDefaultFallback() {
//            return defaultFallback;
//        }
//
//        public void setDefaultFallback(FallbackUtils.FallbackType defaultFallback) {
